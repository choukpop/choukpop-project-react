        ...
        <section className="genshin-sidebar fixed top-[0] left-[0] h-full z-[100] duration-500 transition-all ease-in-out">
            ...
            <ul className="genshin-nav-links w-full h-full py-4 px-0">
                <li className="relative list-none duration-500 ease-in-out">
                    <Link className="genshin-link-name text-xl font-semibold text-white duration-500 ease-in-out flex items-center no-underline py-4" to="/genshin">
                ...
                <li className="relative list-none duration-500 ease-in-out">
                    <Link className="genshin-link-name text-xl font-semibold text-white duration-500 ease-in-out flex items-center no-underline py-4" to="/genshin/characters">
                ...
                <li className={subMenuOpen ? "relative list-none duration-500 ease-in-out showMenu" : "relative list-none duration-500 ease-in-out"}>
                    <div className="cursor-pointer flex items-center justify-between" style={subMenuOpen ? { background: "#1d1b31" } : {}} onClick={() => setSubMenuOpen(!subMenuOpen)}>
                        <Link className="genshin-link-name text-xl font-semibold text-white duration-500 ease-in-out flex items-center no-underline py-4">
                    ...
                    <ul className="gesnhin-sub-menu text-white pt-2 pr-2 pb-4 pl-20 mt-[-10px] hidden">
                        ...
                        <li className="my-4"><Link className="text-white text-lg font-normal py-3 px-0 opacity-50 whitespace-nowrap duration-500 ease-in-out hover:opacity-100 select-none" to="/genshin/database/items"><span className="menu-dot">●</span>{t('sidebar.database.items')}</Link></li>
                        <li className="my-4"><Link className="text-white text-lg font-normal py-3 px-0 opacity-50 whitespace-nowrap duration-500 ease-in-out hover:opacity-100 select-none" to="/genshin/database/weapons"><span className="menu-dot">●</span>{t('sidebar.database.weapons')}</Link></li>
                        <li className="my-4"><Link className="text-white text-lg font-normal py-3 px-0 opacity-50 whitespace-nowrap duration-500 ease-in-out hover:opacity-100 select-none" to="/genshin/database/artifacts"><span className="menu-dot">●</span>{t('sidebar.database.artifacts')}</Link></li>
                    </ul>
                </li>

                <li className="relative list-none duration-500 ease-in-out">
                    <Link className="genshin-link-name text-xl font-semibold text-white duration-500 ease-in-out flex items-center no-underline py-4" to="/genshin/settings">
